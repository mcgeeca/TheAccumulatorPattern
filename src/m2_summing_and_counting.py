...
def run_test_sum_more_cosines():
    ...
    print('       actual:  ', answer)
    #Test 3:
    expected = -0.81595  # This is APPROXIMATELY the correct answer.
    ...
    print('       actual:  ', answer)
    #Test 5:
    expected = 0.29666  # This is APPROXIMATELY the correct answer.
    answer = sum_more_cosines(4, 12)
    print('Test 1 expected:', expected, '(approximately)')
    print('       actual:  ', answer)
...
def sum_more_cosines(m, n):
    ...
    #   That is called TEST-DRIVEN DEVELOPMENT (TODD).
    #
