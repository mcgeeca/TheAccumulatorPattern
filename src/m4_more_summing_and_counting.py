...
def run_test_count_cosines_from():
    ...
    # Test 7:
    expected = 5
    answer = count_cosines_from(6, 12, -.20)
    print('Test 7 expected:', expected)
    print('       actual:  ', answer)
    # Test 8:
    expected = 2
    answer = count_cosines_from(5, 10, 0.69)
    print('Test 8 expected:', expected)
    print('       actual:  ', answer)
    # Test 9:
    expected = 6
    answer = count_cosines_from(7, 14, -0.27)
    print('Test 9 expected:', expected)
    print('       actual:  ', answer)
    # Test 10:
    expected = 2
    answer = count_cosines_from(8, 16, 0.29)
...
def run_test_sum_unit_fractions_from():
    ...
    print('       actual:  ', answer)
    # Test 3:
    expected = 2.391457  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(3, 27)
    print('Test 3 expected:', expected, '(approximately)')
    print('       actual:  ', answer)
    # Test 4:
    expected = 1.083333  # This is APPROXIMATELY the correct answer.
    ...
    # ------------------------------------------------------------------
    # Test 5:
    expected = 0.950000  # This is APPROXIMATELY the correct answer.
